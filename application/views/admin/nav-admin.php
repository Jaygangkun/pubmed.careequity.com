...
<div style="flex-grow: 8;"><a class="nav-logo-link" href="https://tools.careequity.com/"><img src="<?= base_url() ?>assets/img/new_logo.svg" class="header_logo"></a></div>
    ...
    ?>
    <div style="text-align: right;"><a href="<?php echo base_url('/users')?>" class="header_admin_wrap"><img src="<?= base_url() ?>assets/img/admin.png" class="header_admin"><img src="<?= base_url() ?>assets/img/admin_hover.png" class="header_admin_hover"></a></div>
